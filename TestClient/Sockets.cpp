///////////////////////////////////////////////////////////////
//Sockets.cpp - Socket class from Dr. Fawcett's repository.  //
// This class wraps the windows API to allow it to be used   //
// in c++. Implementation file                               //
...
std::string Socket::recvString(byte terminator)
{
    ...
    while (true)
    {
        ...
        {
            StaticLogger<1>::write("invalid socket in rcvr");
            break;
        }
